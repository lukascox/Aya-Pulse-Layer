#!/bin/sh
# pulse_lite v3.2 -- AutoTDP daemon, KONKR Pocket FIT / Snapdragon G3 Gen 3
...
# -- heavy sub-tier thresholds (millidegrees C) -- PLACEHOLDERS, replace after
#    soak test below. Independent CPU and GPU thresholds -- worst-case wins.
